      ...
      <div class="container relative">
        ...
        <div class="pull-left">
          ...
          <div class="header-inner">
            <!-- BEGIN LOGO -->
            <a href="index.php"><img src="asset/image/logo-small.png"></a>
          </div>
        </div>
        ...
        <div class="menu-content mobile-light pull-right clearfix" data-pages-direction="slideRight" id="header">
          ...
          <div class="header-inner">
            <ul class="menu no-padding">
                  <li>
                    <a class="btn btn-danger btn-md text-white text-block bold" href="#" data-text="Rent">Rent your space </a>
                  </li>
                  <li>
                    <a class="bold" href="signup.php" data-text="Sign Up">Sign Up </a>
                  </li>
                  <li>
                    <a class="bold" href="#" data-text="Login">Log In</a>
                  </li>
                </ul>
            <!-- BEGIN COPYRIGHT FOR MOBILE -->
            <div class="font-arial m-l-35 m-r-35 m-b-20 visible-sm visible-xs m-t-20">
              <p>Malaysian No.1 Rent Market Place.</p>
              <p class="fs-11 small-text muted">Copyright &copy; 2017 Rent Market</p>
            </div>
