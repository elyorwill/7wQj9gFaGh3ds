        ...
        <div class="content-container clearfix">
          <div class="col-md-12">
            ...
            <a data-toggle="tab" href="#avail">Available</a>
             | 
            <a data-toggle="tab" href="#rent">Rented</a>
             | 
            <a data-toggle="tab" href="#hide">Hidden</a>
            </p>
            <hr>
            <input type="search" placeholder="Search Space" class="form-control space-search m-t-20" />
            ...
            <div class="tab-content p-t-20">
                  ...
                  <div class="col-md-4 type-section">
                    ...
                    <div class="bottom-detail">
                      ...
                      <div class="row p-t-10">
                        <a class="pull-right btn btn-danger btn-lg text-white text-block bold m-t-5" href="self-space.php" data-text="view">View space</a>
              ...
              <div class="tab-pane" id="hide">
                <div class="row p-t-3">
                  ...
                  <h2 class="hint-text">You have no hidden space!</h2>
                  <p>Hide your space if you need to temporarily disable renting the space for a while. This is suitable if you would like to renovate the space.</p>
                  </div>
                </div>
              </div> <!-- /. id -->
